-- alatech.activity_day_weight_training_of_first_monday definition

CREATE TABLE `activity_day_weight_training_of_first_monday` (
  ...
  PRIMARY KEY (`user_id`,`year_num`,`week_num`,`day_num`,`muscle`)
